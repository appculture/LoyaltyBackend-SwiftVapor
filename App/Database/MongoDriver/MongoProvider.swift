...
public final class MongoProvider: Vapor.Provider {
    ...
    */
    public convenience init(config: Config) throws {
        guard let mysql = config["mongo"].object else {
            throw Error.noMongoConfig
        }
        ...
        try self.init(host: host, user: user, password: password, database: database, port: port)
    }
